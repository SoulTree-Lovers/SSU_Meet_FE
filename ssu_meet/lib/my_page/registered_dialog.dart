                    ...
                    child: Column(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("${widget.hobbies[0]}".toString(),
                              ...
                              Text("${widget.hobbies[1]}".toString(),
                                textAlign: TextAlign.left,
                                softWrap: true,
                                style: TextStyle(
                                  fontFamily: "Nanum_Ogbice",
                                ...
                                Text("${widget.hobbies[2]}".toString(),
                                textAlign: TextAlign.left,
                                softWrap: true,
                                style: TextStyle(
                                  fontFamily: "Nanum_Ogbice",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text("${widget.introduction}".toString(),
                            textAlign: TextAlign.left,
                            softWrap: true,
                            style: TextStyle(
                              fontFamily: "Nanum_Ogbice",
